...
router.get('/vnpay_return', function (req, res, next) {
    ...
    if (vnp_Params['vnp_SecureHashType']) delete vnp_Params['vnp_SecureHashType'];
    ...
    if(secureHash === signed){
        ...
        const message = getReturnMessage(responseCode);
        res.json({code: responseCode, message: message});
    } else{
...
function getReturnMessage(code) {
    switch (code) {
        ...
        case '07':
            return 'Giao dịch bị nghi ngờ, vui lòng liên hệ VNPAY.';
        case '09':
            return 'Thẻ/Tài khoản chưa đăng ký Internet Banking.';
        case '10':
            return 'Xác thực thẻ/tài khoản không thành công quá 3 lần.';
        case '11':
            return 'Đã hết hạn chờ thanh toán.';
        case '12':
            return 'Thẻ/Tài khoản đã bị khóa.';
        case '13':
            return 'Bạn đã nhập sai mật khẩu xác thực (OTP).';
        case '51':
